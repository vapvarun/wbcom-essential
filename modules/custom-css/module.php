<?php
namespace WbcomElementorAddons\Modules\CustomCss;
...
class Module extends Module_Base {
	...
	public function register_controls( Controls_Stack $element, $section_id ) {
		...
		$element->start_controls_section(
			'section_custom_css',
			[
				'label' => __( 'Custom CSS', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$element->add_control(
			'custom_css_title',
			[
				'raw' => __( 'Add your own custom CSS here', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$element->add_control(
			...
			[
				'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::RAW_HTML,
