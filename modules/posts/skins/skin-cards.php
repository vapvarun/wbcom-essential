...
class Skin_Cards extends Skin_Base {
	...
	public function get_title() {
		return __( 'Cards', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN );
	}
	...
	protected function register_thumbnail_controls() {
		...
		$this->update_control(
			'thumbnail',
			[
				'label' => __( 'Show Image', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'options' => [
					'top' => __( 'Yes', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'none' => __( 'No', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				],
	...
	public function register_additional_design_image_controls() {
		...
		$this->add_control(
			'heading_badge_style',
			[
				'label' => __( 'Badge', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Avatar', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					$this->get_control_id( 'thumbnail!' ) => 'none',
	...
	public function register_badge_controls() {
		...
		$this->add_control(
			'badge_taxonomy',
			[
				'label' => __( 'Badge Taxonomy', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
	...
	public function register_design_card_controls() {
		$this->start_controls_section(
			'section_design_card',
			[
				'label' => __( 'Card', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Box Shadow', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
			    'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
		...
		$this->add_control(
			'hover_effect',
			[
				'label' => __( 'Hover Effect', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'options' => [
					'none' => __( 'None', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'gradient' => __( 'Gradient', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					//'zoom-in' => __( 'Zoom In', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					//'zoom-out' => __( 'Zoom Out', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				],
				'default' => 'gradient',
				'separator' => 'before',
		...
		$this->add_control(
			'meta_border_color',
			[
				'label' => __( 'Meta Border Color', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
