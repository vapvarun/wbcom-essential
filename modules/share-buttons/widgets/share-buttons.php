<?php
namespace WbcomElementorAddons\Modules\ShareButtons\Widgets;

use Elementor\Controls_Manager;
use Elementor\Group_Control_Typography;
use Elementor\Repeater;
use WbcomElementorAddons\Base\Base_Widget;
use WbcomElementorAddons\Modules\ShareButtons\Module;
...
class Share_Buttons extends Base_Widget {
	...
	public function get_title() {
		return __( 'Share Buttons', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Share Buttons', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
			]
		);
		...
		$repeater->add_control(
			'button',
			[
				'label' => __( 'Network', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$this->add_control(
			'view',
			[
				'label' => __( 'View', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'options' => [
					'icon-text' => 'Icon & Text',
		...
		$this->add_control(
			'show_counter',
			[
				'label' => __( 'Count', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'label_off' => __( 'Hide', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'skin',
			[
				'label' => __( 'Skin', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'gradient' => __( 'Gradient', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'minimal' => __( 'Minimal', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'framed' => __( 'Framed', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'boxed' => __( 'Boxed Icon', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'flat' => __( 'Flat', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				],
				'default' => 'gradient',
		...
		$this->add_control(
			'shape',
			[
				'label' => __( 'Shape', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'square' => __( 'Square', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'rounded' => __( 'Rounded', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
					'circle' => __( 'Circle', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				],
				'default' => 'square',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => __( 'Justify', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$this->add_control(
			'share_url_type',
			[
				'label' => __( 'Target URL', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'current_page' => __( 'Current Page', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$this->add_control(
			'share_url',
			[
				'label' => __( 'URL', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$this->add_responsive_control(
			'button_size',
			[
				'label' => __( 'Button Size', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0.5,
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => __( 'Icon Size', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'em' => [
						'min' => 0.5,
		...
		$this->add_responsive_control(
			'button_height',
			[
				'label' => __( 'Button Height', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'em' => [
						'min' => 1,
		...
		$this->add_responsive_control(
			'border_size',
			[
				'label' => __( 'Border Size', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'default' => [
					'size' => 2,
		...
		$this->add_control(
			'primary_color',
			[
				'label' => __( 'Primary Color', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
		...
		$this->add_control(
			'secondary_color',
			[
				'label' => __( 'Secondary Color', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
