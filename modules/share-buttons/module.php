<?php
namespace WbcomElementorAddons\Modules\ShareButtons;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_filter( 'wbcom_elementor_addons/frontend/localize_settings', [ $this, 'add_localize_data' ] );

		add_filter( 'wbcom_elementor_addons/editor/localize_settings', [ $this, 'add_localize_data' ] );
	}
}
