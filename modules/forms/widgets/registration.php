...
class Registration extends Base_Widget {
	...
	public function get_title() {
		return __( 'Registration', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Register Button', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Register', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Redirect After Registration', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( ' Username', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'condition' => [
					'show_labels' => 'yes',
					'custom_labels' => 'yes',
				],
		...
		$this->add_control(
			'email_label',
			[
				'label' => __( 'Email Label', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::TEXT,
				'default' => __( ' Email', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'condition' => [
					'show_labels' => 'yes',
					'custom_labels' => 'yes',
				],
		...
		$this->add_control(
			'email_placeholder',
			[
				'label' => __( 'Email Placeholder', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'type' => Controls_Manager::TEXT,
				'default' => __( ' Email', WBCOM_ELEMENTOR_ADDONS_TEXT_DOMAIN ),
				'condition' => [
					'show_labels' => 'yes',
