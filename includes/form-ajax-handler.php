		...
		if( isset( $_POST['serialize_form_data'] ) && !empty( $_POST['serialize_form_data'] ) ) {
			if( isset( $_POST['action_to_to'] ) && ( $_POST['action_to_to'] == 'login' ) ) {
				...
				$credentials = array(
					...
					'user_password'	=>	isset( $form_data['pwd'] ) ? sanitize_text_field( $form_data['pwd'] ) : '',
					'remember'	=>	isset( $form_data['rememberme'] ) ? sanitize_text_field( $form_data['rememberme'] ) : '',
				);
