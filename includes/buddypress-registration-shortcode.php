...
if ( ! class_exists( 'WBCOM_BuddyPress_Registration_Shortcode' ) ) :

/**
 * Main WBCOM_BuddyPress_Registration_Shortcode Class.
 *
 * @class WBCOM_BuddyPress_Registration_Shortcode
 */
class WBCOM_BuddyPress_Registration_Shortcode {
	...
	/**
	 * Main WBCOM_BuddyPress_Registration_Shortcode Instance.
	 *
	 * Ensures only one instance of WBCOM_BuddyPress_Registration_Shortcode is loaded or can be loaded.
	 *
	 * @return WBCOM_BuddyPress_Registration_Shortcode - Main instance.
	 */
	...
	/**
	 * WBCOM_BuddyPress_Registration_Shortcode Constructor.
	 */
	...
	public function render_wbcom_bbp_registration_form() {
		ob_start();
		if( function_exists( 'buddypress' ) ) {
			...
			if( is_admin() ) {
				...
				if ( is_user_logged_in() ) {
					...
					sprintf( __( 'You are Logged in as %1$s (<a href="%2$s">Logout</a>)', 'wbcom-essential' ), $current_user->display_name, wp_logout_url() ) .
							'</div>';
				}
				else {
			...
			_e( 'Please Activate BuddyPress To Use This Shortcode', 'wbcom-essential' );
		}
		$html = ob_get_clean();
		return $html;
	}

	public function wbcom_bp_core_screen_signup_clone() {
		$bp = buddypress();
...
WBCOM_BuddyPress_Registration_Shortcode::instance();