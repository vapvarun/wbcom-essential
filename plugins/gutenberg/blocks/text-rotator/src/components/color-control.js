...
const THEME_COLORS = [
	...
	{ name: __( 'Success', 'wbcom-essential' ), color: '#38a169' },
	{ name: __( 'Danger', 'wbcom-essential' ), color: '#e53e3e' },
	{ name: __( 'Warning', 'wbcom-essential' ), color: '#d69e2e' },
	{ name: __( 'Info', 'wbcom-essential' ), color: '#00b5d8' },
	{ name: __( 'Light', 'wbcom-essential' ), color: '#f7fafc' },
	{ name: __( 'Dark', 'wbcom-essential' ), color: '#1a202c' },
	{ name: __( 'White', 'wbcom-essential' ), color: '#ffffff' },
	{ name: __( 'Black', 'wbcom-essential' ), color: '#000000' },
];
