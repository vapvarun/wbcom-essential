...
const DEVICES = [
	{ label: __( 'Desktop', 'wbcom-essential' ), value: 'Desktop', icon: desktop },
	{ label: __( 'Tablet', 'wbcom-essential' ), value: 'Tablet', icon: tablet },
	{ label: __( 'Mobile', 'wbcom-essential' ), value: 'Mobile', icon: mobile },
];
...
export default function ResponsiveControl( { label, children, device, onDeviceChange } ) {
	...
	return (
		<BaseControl
			label={ label }
			className="wbe-responsive-control"
		>
			<div className="wbe-responsive-control__header">
				<ButtonGroup className="wbe-responsive-control__devices">
			...
			<div className="wbe-responsive-control__content">
