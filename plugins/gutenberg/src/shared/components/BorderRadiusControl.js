...
const CORNERS = [
	{ key: 'top', label: __( 'TL', 'wbcom-essential' ) },
	{ key: 'right', label: __( 'TR', 'wbcom-essential' ) },
	{ key: 'bottom', label: __( 'BR', 'wbcom-essential' ) },
	{ key: 'left', label: __( 'BL', 'wbcom-essential' ) },
];
...
export default function BorderRadiusControl( {
	...
	return (
		<BaseControl
			...
			className="wbe-border-radius-control"
		>
			<Flex align="flex-end" gap={ 2 }>
				{ linked ? (
					<FlexItem>
						<NumberControl
							label={ __( 'All corners', 'wbcom-essential' ) }
							value={ values.top }
				...
				<FlexItem>
					<Button
						...
						label={ linked
							? __( 'Unlink corners', 'wbcom-essential' )
							: __( 'Link corners', 'wbcom-essential' )
						}
