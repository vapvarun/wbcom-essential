...
import { BaseControl, ColorPalette, Button, Popover } from '@wordpress/components';
...
const THEME_COLORS = [
	...
	{ name: __( 'Light Gray', 'wbcom-essential' ), color: '#e3e3e3' },
	...
	return (
		<BaseControl label={ label } className="wbcom-color-control">
			<div className="wbcom-color-control-inner">
				...
				/>
				{ value && (
					<Button isSmall variant="tertiary" onClick={ () => onChange( '' ) }>
