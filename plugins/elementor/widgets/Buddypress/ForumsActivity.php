					...
					while ( bbp_topics() ) :
						...
						<div class="wbcom-essential-fa wbcom-essential-fa--item">
							...
							<?php if ($settings['switch_forum_title']) : ?>
								<div class="wbcom-essential-fa__forum-title"><?php echo $forum_title; ?></div>
							<?php endif; ?>
							...
							<?php if ($settings['switch_link']) : ?>
								<div class="wbcom-essential-fa__link"><a href="<?php echo $get_discussion_link; ?>"><?php echo $settings['button_text']; ?></a></div>
							<?php endif; ?>
