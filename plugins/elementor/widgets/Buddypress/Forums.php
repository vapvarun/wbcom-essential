		...
		<div class="wbcom-essential-forums <?php echo ( !bbp_has_topics( $args ) ) ? 'wbcom-essential-forums--blank' : ''; ?>">
												...
												<?php if ($settings['switch_meta']) : ?>
													<div class="wbcom-essential-forums__ww">
														<span class="bs-replied">
															...
															?>
															<span class="bbp-topic-freshness-author"><?php //echo $bbp_author_link; ?></span> <?php _e('replied', 'wbcom-essential'); ?> <?php bbp_topic_freshness_link(); ?>
														</span>
			...
			<?php else : ?>
				...
				<div class="wbcom-essential-no-data wbcom-essential-no-data--forums">
					<img class="wbcom-essential-no-data__image" src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/dfy-no-data-icon02.svg" alt="Forums" />
