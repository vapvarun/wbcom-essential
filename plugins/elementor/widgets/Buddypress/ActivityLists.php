...
class ActivityLists extends \Elementor\Widget_Base {
	...
	public function wbcom_essential_elementor_activity_default_scope( $scope = 'all', $user_id = 0, $group_id = 0 ) {
		$new_scope = array();
		 ...
		 */
		$new_scope = apply_filters( 'wbcom_essential_elementor_activity_default_scope', $new_scope );
	...
	protected function render() {
	    global $wbcom_essential_elementor_activity;
		...
		add_filter( 'bp_excerpt_length', array( $this, 'wbcom_essential_elementorchange_activity_content_excerpt_length' ), 99, 1 );
		...
		$args['scope'] = $this->wbcom_essential_elementor_activity_default_scope();
		...
		$wbcom_essential_elementor_activity = true;
		?>
											...
											<li class="<?php bp_activity_css_class(); ?>" id="activity-<?php bp_activity_id(); ?>" data-bp-activity-id="<?php bp_activity_id(); ?>" data-bp-timestamp="<?php bp_nouveau_activity_timestamp(); ?>" data-bp-activity="<?php ( function_exists('bp_nouveau_edit_activity_data') ) ? bp_nouveau_edit_activity_data() : ''; ?>" >
												...
												<div class="bp-activity-head">
													...
													<div class="activity-header">
                                                        ...
                                                        <?php
														if ( function_exists( 'wbcom_essential_elementor_bp_nouveau_activity_privacy' ) ) {
															wbcom_essential_elementor_bp_nouveau_activity_privacy();
														}
														?>
													</div>
												</div>
		...
		remove_filter( 'bp_excerpt_length', array( $this, 'wbcom_essential_elementorchange_activity_content_excerpt_length' ), 99, 1 );
	}
	...
	public function wbcom_essential_elementorchange_activity_content_excerpt_length( $length ) {
		$length = 135;
		return $length;
	}
