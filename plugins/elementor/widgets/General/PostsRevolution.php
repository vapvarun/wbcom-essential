	...
	protected function render() {
		...
		if($wbcom_custom_style == 'on') {
			if($wbcom_post_display_type == 'posts_type1') {
				$return .=  '.wbcom-essential-posts-revolution-elementor.posts_type1.admpselector-'.$instance.' .admp-category a {
											color:'.$wbcom_main_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type1.admpselector-'.$instance.' .admp-category a:hover {
								color:'.$wbcom_hover_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type1.admpselector-'.$instance.' .admp-title a:hover {
								color:'.$wbcom_hover_color.'!important;
							}';
			}
			if($wbcom_post_display_type == 'posts_type2') {
				$return .=  '.wbcom-essential-posts-revolution-elementor.posts_type2.admpselector-'.$instance.' .admp-category a {
											color:'.$wbcom_main_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type2.admpselector-'.$instance.' .admp-category a:hover {
								color:'.$wbcom_hover_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type2.admpselector-'.$instance.' .admp-title a:hover {
								color:'.$wbcom_hover_color.'!important;
							}';
			}
			if($wbcom_post_display_type == 'posts_type3') {
				$return .=  '.wbcom-essential-posts-revolution-elementor.posts_type3.admpselector-'.$instance.' .admp-category a {
											color:'.$wbcom_main_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type3.admpselector-'.$instance.' .admp-category a:hover {
								color:'.$wbcom_hover_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type3.admpselector-'.$instance.' .admp-title a:hover {
								color:'.$wbcom_hover_color.'!important;
							}';
			}
			if($wbcom_post_display_type == 'posts_type4') {
				$return .=  '.wbcom-essential-posts-revolution-elementor.posts_type4.admpselector-'.$instance.' .admp-category a {
											color:'.$wbcom_main_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type4.admpselector-'.$instance.' .admp-category a:hover {
								color:'.$wbcom_hover_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type4.admpselector-'.$instance.' .admp-title a:hover {
								color:'.$wbcom_hover_color.'!important;
							}';
			}
			if($wbcom_post_display_type == 'posts_type5') {
				$return .=  '.wbcom-essential-posts-revolution-elementor.posts_type5.admpselector-'.$instance.' .admp-category a {
											color:'.$wbcom_main_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type5.admpselector-'.$instance.' .admp-category a:hover {
								color:'.$wbcom_hover_color.'!important;
							}
							.wbcom-essential-posts-revolution-elementor.posts_type5.admpselector-'.$instance.' .admp-title a:hover {
								color:'.$wbcom_hover_color.'!important;
							}';
			}
		}
		...
		// LOOP QUERY
		$query = wbcom_essential_posts_revolution_elementor_query($wbcom_query_source,
							$wbcom_query_sticky_posts,
							$wbcom_query_posts_type,
							$wbcom_query_categories,
							$wbcom_query_order,
		...
		if($wbcom_animate == 'on') { // ANIMATION ON
			...
			$return .= '<div class="wbcom-essential-posts-revolution-elementor '.$wbcom_post_display_type.' admpselector-'.$instance.'">';
		...
		if($wbcom_post_display_type == 'posts_type1') {
			...
			if($count == '0') {
				...
				$return .= '<div class="admp_three_fifth">';
						...
						$return .= '<div class="admp-info-left">';
								$return .= '<span class="admp-category">'.wbcom_essential_posts_revolution_elementor_category($wbcom_query_source,$wbcom_query_posts_type).'</span>';
								$return .= '<span class="admp-title"><a href="'.$link.'">'.get_the_title().'</a></span>';
								if($wbcom_post_display_excerpt == 'true') {
									$return .= '<span class="admp-content">'.wbcom_essential_posts_revolution_elementor_excerpt($wbcom_post_display_excerpt_number).'</span>';
								}
								$return .= '<span class="admp-author">'.get_the_author().'</span>';
								$return .= '<span class="admp-date">'.get_the_date($wbcom_post_display_date_format).'</span>';
						$return .= '</div>';
				...
				$return .= '<div class="admp_two_fifth ad_last">';

						$return .= '<div class="wbcom-posts-revolution-elementor-thumbs-container admp_one_third">'.wbcom_essential_posts_revolution_elementor_thumbs().'</div>';
			...
			$return .= '<div class="container-display4"><div class="wbcom-posts-revolution-elementor-thumbs-container ad_one_half">'.wbcom_essential_posts_revolution_elementor_thumbs().'
			...
			if($count == '0') {
				...
				$return .= '<div class="admp_two_fifth ad_last">';
						...
						$return .= '<div class="admp-info-right ad_last">';
								$return .= '<span class="admp-title"><a href="'.$link.'">'.get_the_title().'</a></span>';
								$return .= '<span class="admp-category">'.wbcom_essential_posts_revolution_elementor_category($wbcom_query_source,$wbcom_query_posts_type).'</span>';
						$return .= '</div><div class="adclear"></div>';
