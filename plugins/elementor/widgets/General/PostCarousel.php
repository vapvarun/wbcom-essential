...
class PostCarousel extends \Elementor\Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_script( 'wb-post-carousel', WBCOM_ESSENTIAL_ELEMENTOR_URL . 'assets/js/post-carousel.min.js', array( 'jquery', 'elementor-frontend' ), WBCOM_ESSENTIAL_VERSION, true );
	}
				...
				<?php } ?>
					...
					<div class="wbcom-posts-card-footer">
						...
						<div class="wbcom-posts-card-date <?php echo esc_attr($settings['card_footer_layout']) ?>">
							...
							<?php if ($settings['display_author_url']) { ?>
							<a class="wbcom-posts-card-author-link" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>">
