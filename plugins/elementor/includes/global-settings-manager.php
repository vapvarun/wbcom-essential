...
// namespace WBCOMESSENTIAL\Modules\Social\Classes;

use Elementor\Controls_Manager;
use Elementor\Settings;
use Elementor\Utils;
use Elementor\Widget_Base;
// use WBCOMESSENTIAL\Plugin;
...
class WBCOM_Additional_Elementor_Global_Settings {
	...
	public function __construct() {
		if ( is_admin() ) {
			add_action( 'elementor/admin/after_create_settings/' . Settings::PAGE_ID, array( $this, 'register_admin_fields' ) );
		}
	...
	public function sync_wbcom_setting_and_elementor( $option_name, $old_value, $value ) {
		...
		if ( isset( $_POST['action'] ) && ( $_POST['action'] == 'elementor_apply_scheme' ) ) {
			...
			} elseif ( $option_name == 'elementor_scheme_color' ) {
