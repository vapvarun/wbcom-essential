...
class Plugin {
    ...
    public function enqueue_frontend_scripts() {
        ...
        wp_register_script(
                $handle = 'wbcom_elementor_main_js', $src = plugin_dir_url(__FILE__) . 'assets/js/main.js', $deps = array('jquery'), $ver = time(), $in_footer = true
        );
        ...
        wp_localize_script(
                'wbcom_elementor_main_js', 'essential_js_obj', array(
            'reign_rtl' => $rtl
                )
        );
