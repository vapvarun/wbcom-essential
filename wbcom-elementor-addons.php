<?php
/**
 * Plugin Name: WBCOM Elementor Addons
 * Description: WBCOM Elementor Addons.
...
define( 'WBCOM_ELEMENTOR_ADDONS_VERSION', '1.0.0' );
define( 'WBCOM_ELEMENTOR_ADDONS_PREVIOUS_STABLE_VERSION', '1.0.0' );
