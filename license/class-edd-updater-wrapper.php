 ...
 */
class WBCOM_ESSENTIAL_EDD_Updater_Wrapper {
    ...
    public function filter_edd_strings( $translated, $text, $domain ) {
        ...
        $strings_to_translate = array(
            'There is a new version of %1$s available.' => __( 'There is a new version of %1$s available.', 'wbcom-essential' ),
            'Contact your network administrator to install the update.' => __( 'Contact your network administrator to install the update.', 'wbcom-essential' ),
            'View version %2$s details' => __( 'View version %2$s details', 'wbcom-essential' ),
            'Update now.' => __( 'Update now.', 'wbcom-essential' ),
            'You do not have permission to install plugin updates' => __( 'You do not have permission to install plugin updates', 'wbcom-essential' ),
            'Error' => __( 'Error', 'wbcom-essential' ),
        );
